    ...
    return (
        <div>
            ...
            <div className="mobile-span">
                {images == 1 && <span>“მადლობას ვუხდი ქალბატონ ლელას გაწეული მკურნალობისთვის, მართლაც რომ ძალიან შედეგიანი ნაყენია “ქავთასი”, მან გამკურნა ჰემეროიდისგან და მოახდინა კომპლექსური მკურნალობა.”</span>}
                {images == 2 && <span>“ქავთასმა მომიგვარა უსერიოზულესი ღვიძლის პრობლემები, აბსოლიტურად დაარეგულირა, როგორც ღვიძლის ფუნქციები ასევე აღადგინა იგი ხარისხობრივად. დიდ რეკომენდაციას ვუწევ ქავთასს და მადლობას ვუხდი ქნ. ლელა გეჯაძეს.”</span>}
                {images == 3 && <span>“მინდა რეკომენდაცია გავუწიო ქავთასს, არაჩვეულებრივი წამალია ზოგადად იმუნიტეტისთვის, დიდ მადლობას ვუხდი ქნ. ლელა გეჯაძეს გაწეული პროფესიონალური მომსახურებისთვის”</span>}
                {images == 4 && <span> - უკიდეგანოდ მადლობელი ვარ ეს საშინელი ტანჯვა რომ მომაცილეთ, ბოლო იმედი იყო ქავთასი ჩემთვის, ოპერაციის გაკეთება მესაჭიროებოდა. შედეგი მივიღე მეორე დღესვე, რაც ქავთასის მომხმარებელი გავხდი, ტკივილგამაყუჩებლები დამავიწყდა.”</span>}
            </div>
